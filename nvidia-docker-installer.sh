...
set -x
NVIDIA_DRIVER_VERSION="${NVIDIA_DRIVER_VERSION:-418.116.00}"
...
install_nvidia_docker2() {
  ...
  apt-get install -y nvidia-docker2=2.0.3+docker18.09.4-1 nvidia-container-runtime=2.0.0+docker18.09.4-1
}
